...
import (
	...
	backupv1alpha1 "github.com/morheus9/autobackup-manifest-operator/api/v1alpha1"
	"github.com/morheus9/autobackup-manifest-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f9f439e7.example.com",
